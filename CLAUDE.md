...
- Core POS feature requirements (product/inventory management, checkout, transactions, reporting) are documented in [docs/PRD_POS_CORE_FEATURES.md](docs/PRD_POS_CORE_FEATURES.md). Consult it before implementing or modifying any core POS feature to stay aligned with defined scope, data models, and acceptance criteria.
