    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <x-data-table
            ...
            <x-slot name="headers">
                ...
                <th class="px-6 py-3 text-left font-semibold">{{ __('Phone') }}</th>
                <th class="px-6 py-3 text-left font-semibold">{{ __('Email') }}</th>
...
function loadCustomersTable() {
    loadTableData('customersTable', buildFilterUrl('customersTable'), function(item) {
