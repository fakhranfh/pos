...
<div class="py-12">
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="border-t border-gray-200 dark:border-gray-700 py-4">
          <dt class="text-sm font-medium text-gray-600 dark:text-gray-400">@lang('Sku')</dt>
          <dd class="mt-1 text-sm text-gray-900 dark:text-white">
            {{ $item->sku }}
          </dd>
        </div>
        ...
        <div class="border-t border-gray-200 dark:border-gray-700 py-4">
          <dt class="text-sm font-medium text-gray-600 dark:text-gray-400">@lang('Stock')</dt>
          <dd class="mt-1 text-sm text-gray-900 dark:text-white">
            {{ $item->stock }}
          </dd>
        </div>
        <div class="border-t border-gray-200 dark:border-gray-700 py-4">
          <dt class="text-sm font-medium text-gray-600 dark:text-gray-400">@lang('Low Stock Threshold')</dt>
          <dd class="mt-1 text-sm text-gray-900 dark:text-white">
        ...
        <div class="border-t border-gray-200 dark:border-gray-700 py-4">
          <dt class="text-sm font-medium text-gray-600 dark:text-gray-400">@lang('Is Active')</dt>
          <dd class="mt-1 text-sm text-gray-900 dark:text-white">
            {{ $item->is_active }}
          </dd>
        </div>
